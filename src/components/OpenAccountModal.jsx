...
const OpenAccountModal = () => {
  return (
    <section className="fixed top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] bg-[#f3f3f3] z-50 rounded-lg">
      <div className="max-w-lg p-4 ">
        <div className="flex justify-between mb-4">
          <p></p>
          <button className="text-xl md:text-3xl cursor-pointer font-semibold">
            x
          </button>
        </div>
        <div className="px-2">
